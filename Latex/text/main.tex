...
% -------------------------------------------------------------------------------------------------
%
\lmutitle{Reinforcement Learning for Imperfect Information Games Using the Trick Card Game Schafkopf as a Case Study}
% title: you can force a new line by
...
%
    ...
    \input{text/EvaluationMethods.tex}
